...
import com.zm.springbootcache.bean.EmployeeExample;
import com.zm.springbootcache.bean.EmployeeExample.Criteria;
import com.zm.springbootcache.bean.EmployeeExample.Criterion;
...
public class EmployeeSqlProvider {
    ...
    public String insertSelective(Employee record) {
        ...
        if (record.getEmpStatus() != null) {
            sql.VALUES("emp_status", "#{empStatus,jdbcType=VARCHAR}");
        }
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        if (record.getEmpStatus() != null) {
            sql.SET("emp_status = #{record.empStatus,jdbcType=VARCHAR}");
        }
    ...
    public String updateByPrimaryKeySelective(Employee record) {
        ...
        if (record.getEmpStatus() != null) {
            sql.SET("emp_status = #{empStatus,jdbcType=VARCHAR}");
        }
